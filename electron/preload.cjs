...
const INVOKE_CHANNELS = new Set([
  ...
  'chat:shellSessions:list',
  'chat:shellSessions:readLog',
  'chat:shellSessions:stop',
  'chat:shellSessions:restart',
  'chat:config:read',
  'chat:events:read',
  'chat:fileChanges:read',
  'chat:uiPrompts:read',
  'chat:uiPrompts:request',
  'chat:uiPrompts:respond',
  'chat:runs:read',
  'cli:install',
  'cli:status',
  'cli:uninstall',
...
const EVENT_CHANNELS = new Set([
  ...
  'chat:config:update',
  'chat:events:update',
  'chat:fileChanges:update',
  'chat:runs:update',
  'chat:session:update',
  'chat:uiPrompts:update',
  'config:switched',
  'config:update',
  'config:updated',
  'events:update',
